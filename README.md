...
| [**Pipeflow**](https://glennfriend.github.io/online-toolbox-public/pipeflow/ "https://glennfriend.github.io/online-toolbox-public/pipeflow/") | 貼上資料,程式偵測 tags 並推薦轉換,點一下串成管線(轉 JSON/Markdown、排序、統計、萃取連結、分組加總、SQL Schema→ER 圖、Mermaid 出圖、用 DuckDB 對 CSV 下 SQL、文章逐段翻譯出雙語);改第一格後面全部跟著變 |
